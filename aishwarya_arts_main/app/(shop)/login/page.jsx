...
export const metadata = {
  ...
  title: "Customer Login & Account Portal | Aishwarya Arts",
  description: "Sign in to your Aishwarya Arts customer account to securely track handcrafted Tanjore painting orders, manage your wishlist, and check purchase history.",
  keywords: [
  ...
  openGraph: {
    ...
    description: "Access your Aishwarya Arts account to manage orders and saved masterpieces.",
  ...
  robots: {
    index: false, // Prevents sensitive user portal paths from index bloat
    follow: true,
    googleBot: {
      index: false,
      follow: true,
