...
const PrintableInvoice = forwardRef(
  ({ order, subtotal, gst, shipping, amountInWords }, ref) => {
    ...
    const halfGst = (gst / 2).toLocaleString("en-IN", {
    ...
    return (
      <div
        ref={ref}
        className="bg-white p-10 text-slate-900 w-[210mm] h-auto  mx-auto font-sans text-[10px] leading-tight"
      >
        {/* --- TOP HEADER --- */}
        ...
        <div className="flex justify-between items-start mb-6">
          <div className="flex items-center gap-3">
            ...
            />
            <div>
              <h2 className="text-xl font-black text-amber-900 leading-none">
                Aishwarya Arts
              </h2>
              <p className="text-[8px] font-bold text-slate-600 mt-1 uppercase">
                3/648 , Thuraiyur Road, N. Kosavampatti, Namakkal, Tamilnadu -
                637002
              </p>
              <p className="text-[9px] font-semibold mt-1 italic">
                Authentic Tanjore Handmade Paintings
              </p>
              <p className="text-[9px] font-semibold mt-1 italic">
                Crafting Tanjore Masterpieces{" "}
              </p>
              <p className="text-[9px] mt-1 font-bold">
                GSTIN: <span className="font-mono">33CLWPD1621D1ZH</span>
              </p>
            </div>
          </div>
          ...
          <div className="bg-slate-50 p-4 border border-slate-200 rounded-xl w-60">
            <div className="space-y-1.5 text-[10px]">
              <div className="flex justify-between font-bold">
                <span className="text-slate-900 uppercase">Invoice No:</span>{" "}
                <span>{invoiceNo}</span>
              </div>
              <div className="flex justify-between font-bold">
                <span className="text-slate-900 uppercase">Order ID:</span>{" "}
              ...
              <div className="flex justify-between font-bold">
                <span className="text-slate-900 uppercase">Payment:</span>{" "}
        ...
        <div className="grid grid-cols-2 border-2 border-slate-900 rounded-xl overflow-hidden mb-6">
          <div className="p-4 border-r-2 border-slate-900 bg-slate-50/50">
            <h3 className="text-[9px] font-black text-amber-900 uppercase mb-2">
              Sold By:
            </h3>
            <p className="font-bold text-sm underline underline-offset-2">
          ...
          <tbody>
            {order.orderItems?.map((item, idx) => (
              <tr key={idx} className="border-b border-slate-200">
                ...
                <td className="py-3 px-1 text-center font-bold align-top">
                  {item.quantity}
                </td>
                <td className="py-3 px-2 text-right align-top">
                  ₹{item.price?.toLocaleString()}
                </td>
                <td className="py-3 px-2 text-right align-top text-slate-500 italic">
                  Included
                </td>
                <td className="py-3 px-2 text-right align-top text-slate-500 italic">
                  Included
            ...
            <tr className="border-b border-slate-200 bg-slate-50/30 font-semibold">
              ...
              <td className="py-3 px-2 italic text-slate-600">
          ...
          <div className="flex-1 space-y-4">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="p-3 bg-slate-50/50 rounded-lg border border-slate-100">
                <h5 className="text-[8px] font-black uppercase text-amber-900 mb-1">
                  Bank Details
                </h5>
                <p className="text-[8px] leading-tight">
                  <span className="font-bold uppercase">Canara Bank</span>
                  <br />
                  A/c: 5699723518 | IFSC: CBIN0284000 4461
                </p>
              </div>
              <div className="p-3">
                <h5 className="text-[8px] font-black uppercase text-slate-400 mb-1">
                  Notes
                </h5>
                <p className="text-[8px] text-slate-500 italic leading-tight">
                  100% Handmade Artwork. Goods sold are non-returnable. Subject
                  to Namakkal Jurisdiction.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="mt-auto flex justify-between items-end px-5 pb-2">
          ...
          <div className="text-center w-56">
            <p className="text-[9px] font-black text-amber-900 uppercase mb-4">
              For Aishwarya Arts
            </p>
            <div className="border-b-2 border-slate-900 mb-1"></div>
            <p className="text-[9px] font-black uppercase text-slate-900 tracking-tighter">
